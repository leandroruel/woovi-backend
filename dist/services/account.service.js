...
import { INSUFFICIENT_BALANCE, SENDER_RECEIVER_NOT_FOUND, TRANSACTION_BEING_PROCESSED, } from "@/helpers/constants";
 ...
 */
const calculateChecksum = (accountNumber) => {
 ...
 */
const findOrCreateTransaction = async (transactionData) => {
 ...
 */
const updateAccountBalance = async (senderId, receiverId, amount) => {
...
export const transferAmount = async (data) => {
    const { transferAmountPayload: { senderId, receiverId, amount, idempotencyId }, } = data;
