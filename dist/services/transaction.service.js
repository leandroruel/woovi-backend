 ...
 */
export const transactionExists = async (idempotencyId) => Boolean(await Transaction.exists({ idempotencyId }));
/**
 *  Get transaction by idempotency key
 * @param idempotencyId {string} - Idempotency key
 * @returns {Promise<any>} - Account object
 */
export const getTransaction = async (idempotencyId) => await Transaction.findOne({ idempotencyId });
/**
