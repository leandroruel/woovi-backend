 ...
 * @type {string}
 */
export const CONECTAGOV_API_URL = process.env.CONECTAGOV_API_URL || 'https://api.conecta.gov.br';
/**
 * Url de autenticação da api do ConectaGov
 * @description ConectaGov OAuth URL
 * @type {string}
 */
export const CONECTAGOV_OAUTH_URL = `${CONECTAGOV_API_URL}/oauth2/jwt-token`;
/**
 * Client ID da aplicação no ConectaGov
 * @description ConectaGov Client ID
 * @type {string}
 */
export const CONECTAGOV_CLIENT_ID = process.env.CONECTAGOV_CLIENT_ID || '8ddc46f2-f6a3-4077-9e04-74b55de934a5';
/**
 * Client Secret da aplicação no ConectaGov
 * @description ConectaGov Client Secret
 * @type {string}
 */
export const CONECTAGOV_CLIENT_SECRET = process.env.CONECTAGOV_CLIENT_SECRET || '06d4aaac-1412-45f6-bd7c-38b2bef0d706';
/**
